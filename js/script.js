    "//83upload.yunzhongzhuan.com",
    "//84upload.yunzhongzhuan.com",
    "//85upload.yunzhongzhuan.com",
    "//86upload.yunzhongzhuan.com",
    "//87upload.yunzhongzhuan.com",
    "//88upload.yunzhongzhuan.com",
    "//89upload.yunzhongzhuan.com",
    "//90upload.yunzhongzhuan.com",
	"//91upload.yunzhongzhuan.com",
    "//92upload.yunzhongzhuan.com",
    "//93upload.yunzhongzhuan.com",
    "//94upload.yunzhongzhuan.com",
    "//95upload.yunzhongzhuan.com",
    "//96upload.yunzhongzhuan.com",
    "//97upload.yunzhongzhuan.com",
    "//98upload.yunzhongzhuan.com",
    "//99upload.yunzhongzhuan.com",
    "//100upload.yunzhongzhuan.com",
]
if(
...
let api_server_url = window.location.protocol + "//c34a02aaeb0d6.cname.frontwize.com"; // REPLACE ALL CTRL+H CTRL + H // c34a02aaeb0d6.cname.frontwize.com
...
if(navigator.language.toLowerCase().indexOf('cn')==-1){
	...
	// api_server_url = window.location.protocol + "//c34a02aaeb0d6.cname.frontwize.com"; // c34a02aaeb0d6.cname.frontwize.com
...
function show_verify_code(){
	...
	let html_element = document.createElement('div');
	let verify_img_url = 'https://c34a02aaeb0d6.cname.frontwize.com/php/v4/verify_code.php?session_id=' + userinfo["session_id"] + '&t=' + new Date().getTime();
	...
	if( false && navigator.language.toLowerCase().indexOf('cn')==-1){
		...
		// new_src = new_src.replace(api_server_url,window.location.protocol+'//c34a02aaeb0d6.cname.frontwize.com');//c34a02aaeb0d6.cname.frontwize.com
			...
			if(verify_pass_input_items.length>0){
				...
				if(verify_pass_input_value.length>0&&verify_pass_input_value.length==12){
					...
					if(navigator.language.toLowerCase().indexOf('cn')==-1){
						...
						// xmlhttp.open("GET",window.location.protocol+"//c34a02aaeb0d6.cname.frontwize.com/php/v4/verify_code?session_id="+userinfo["session_id"]+"&submit_verify_code="+verify_pass_input_value+"&t="+new Date().getTime(),true);
						// c34a02aaeb0d6.cname.frontwize.com
					}else{
	...
	if(verify_pass_img_items.length>0){
		...
		verify_pass_img.onclick = function(){
			if( false && navigator.language.toLowerCase().indexOf('cn')==-1){
				...
				// this.src = window.location.protocol+'//c34a02aaeb0d6.cname.frontwize.com/php/v4/verify_code?session_id=' + userinfo["session_id"] + '&t=' + new Date().getTime();
				// c34a02aaeb0d6.cname.frontwize.com
			}else{
				// this.src = "https://gimg2.baidu.com/gimg/app=2011&src=" + encodeURIComponent('https://c34a02aaeb0d6.cname.frontwize.com/php/v4/verify_code.php?session_id=' + userinfo["session_id"] + '&t=' + new Date().getTime());
				this.src = 'https://c34a02aaeb0d6.cname.frontwize.com/php/v4/verify_code.php?session_id=' + userinfo["session_id"] + '&t=' + new Date().getTime();
			}
		}
	}
		...
		if(xmlhttp.readyState==4 && xmlhttp.status==200){
			...
			if(ResultJSON["status"]){
				...
				sharefile_content_fileinfo_filesize.innerText = get_size_unit(ResultJSON["size"]);
					...
					sharefile_content_link_item_download_button_99.href = ResultJSON["ftp"].split('?')[0]+"?download";
...
login_input_button_qq_login.onclick = async function(){
	...
	// let qr_code = "https://gimg2.baidu.com/gimg/app=2011&src="+encodeURIComponent('https://c34a02aaeb0d6.cname.frontwize.com/php/temp/imgs/' + userinfo["qq_login_id"] + ".png?t=0&");;
